...
#SURF는 SIFT의 가속화된 버전 
#SIFT에서는 다양한 스케일 공간에대해서 LoG를 근사한 가우시안 차 영상을 사용합니다. SUFT는 여기서 더 나아가 LOG를 박스 필터로 근사
#속도를 더 빠르게 하기 위해 방향을 계산 안할 수도 있음
...
cv2.rectangle(img, (128,128), (384,384), (255,255,255), -1)
cv2.rectangle(img, (64,64), (256,256), (255,255,255), -1)
